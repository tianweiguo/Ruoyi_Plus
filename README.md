...
> RuoYi-Plus 是基于 RuoYi-Vue-Plus 进行添加新功能
...
# RuoYi-Plus(RuoYi-Vue-Plus)与RuoYi的功能差异
...
| netty     | 添加基于netty实现聊天的功能 > [在线测试 地址：ws://127.0.0.1:18008/ws  ？？发送消息: {'clientID': '', 'cmd': 1, 'data': 'hello world!'}](https://wstool.js.org/) 
| IOT       | 后期添加IOT功能 
